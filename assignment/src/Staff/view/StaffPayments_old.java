 ...
 * @author Admin
 */
public class StaffPayments_old extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(StaffPayments_old.class.getName());

    /**
     * Creates new form StaffPayments
     */
    public StaffPayments_old() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new StaffPayments_old().setVisible(true));
    }
